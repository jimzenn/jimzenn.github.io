...
let $A=\text{1st die shows 1}$, $B=\text{2nd die shows 1}$.<br>
...
We say $A\_1, ..., A\_n$ are **pairwise independent** if for any pair of events $A\_i, A\_j$, $i, j \in \set{ 1, 2, ..., n } $ are independent.
