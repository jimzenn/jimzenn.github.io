...
{{% definition name="The Bernoulli Random Variable" %}}
...
{{% definition name="The Binomial Random Variable" status="" %}}

{{% /definition %}}

{{% definition name="The Geometric random variable" status="" %}}

{{% /definition %}}

{{% definition name="The Poisson random variable" status="" %}}
