...
In general, say $X, Y$ have joint PMF $ P\_{X, Y}$ we can find $P\_X$, and $P\_Y$(called **marginals**) as follow:
...
{{% theorem name="" index="" %}}
Let $g: \R \times \R \to \R$
i.e. g is a real-valued function of 2 variables. Let X, Y have joint PMF, $P\_{X,Y}$.
